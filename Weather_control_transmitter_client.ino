/*
 ...
 project link https://howtomechatronics.com/tutorials/arduino/arduino-wireless-weather-station-project/
*/
#include <SPI.h>
#include <nRF24L01.h>
#include <RF24.h>
...
void loop() {
  ...
  readDHT22 = DHT.read11(dataPin); // Reads the data from the sensor
    u8g2.firstPage();
    do {
      
      switch (draw_state ) {
//        case 0: drawDate(); break;
        case 0: drawInTemperature(); break;
        case 1: drawInHumidity(); break;
        case 2: drawOutTemperature(); break;
        case 3: drawOutHumidity(); break;
      }
    } while ( u8g2.nextPage() );
    draw_state++;
    if (draw_state > 3) {
